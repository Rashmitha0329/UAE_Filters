	...
	public void myTest(Map<String, String> excelTestData) throws Exception {
		...
		try {
	       ...
	       // SearchPage.searchFightsOnHomePageRoundTrip(departFrom,goingTo,date4.day,fromMonthYear,adultsCounts,childCount,infantsCount);
	        ...
	        List<String> selectedStops = SearchPage.selectStopFilter(stopFilters,test);
	        //SearchPage.validateStopsFilterResultInRoundTrip(selectedStops,test);
	        SearchPage.validateStop(selectedStops, test);
		} catch (Exception e) {
