...
public class TCCP_4 extends baseClass {
	...
	public void myTest(Map<String, String> excelTestData) throws Exception {
		...
		try {
            ...
            SearchPage.ValidateArrivalTimeRoundTrip(selected, test);

			List<String> selectedDepart =  SearchPage.clickOnDepartureFilter(departureFilters, test);
			SearchPage.ValidateDepartureTimeRoundTrip(selectedDepart, test);

          String searchByFlightNumber1 = SearchPage.searchByFlightNumberRoundTrip(test);
          SearchPage.flightNumberSearchField(searchByFlightNumber1, test);
//			
          String searchByFlightEquipment1 = SearchPage.searchByFlightEquipmentRoundTrip(test);
          SearchPage.flightEquipmentSearchField(searchByFlightEquipment1, test);
