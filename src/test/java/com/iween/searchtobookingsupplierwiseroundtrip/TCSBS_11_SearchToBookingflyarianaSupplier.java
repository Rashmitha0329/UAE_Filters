package com.iween.searchtobookingsupplierwiseroundtrip;
...
public class TCSBS_11_SearchToBookingflyarianaSupplier extends baseClass {
    ...
    public void myTest(Map<String, String> excelTestData) throws Exception {
        ...
        try {
           ...
           SearchPage.searchFightsOnHomePage(departFrom,goingTo,date2.day,fromMonthYear,date8.day,ReturnMonthYear,adultsCounts,childCount,infantsCount,Class);
        ...
        // Start timing
          ...
          //     String returnFlightTableHtml = flightDetailsRoundTrip.formatFlightDetailsAsTextTable(returnFlightDetails,"Return Flight Details",test);
             ...
             //  flightDetailsRoundTrip. printFlightDetails("RETURN FLIGHT DETAILS", returnFlightDetails);
               ...
               test.log(Status.INFO, "Validating Flight Details Page");
               ScreenshotUtil.captureAndAttachScreenshot1(driver, test, Status.INFO, "Flight Details Page", "Flight Details Page");
