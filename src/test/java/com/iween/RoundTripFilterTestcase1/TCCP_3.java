...
public class TCCP_3 extends baseClass {
    ...
    public void myTest(Map<String, String> excelTestData) throws Exception {
        ...
        try {
        	...
        	test.log(Status.INFO, "Validating FareType");
...
//           
          ...
          resultPage. waitForProgressToComplete();
           ...
           List<String> selectedFares = SearchPage.fareTypeFilter(fareTypes,test);
            SearchPage.validateFareTypeRoundTrip(selectedFares,test);
